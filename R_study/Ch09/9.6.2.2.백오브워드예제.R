...
dtm.wfm <- as.wfm(dtm)
colnames(dtm.wfm) <- c("doc8024", "doc8032", "doc8035")
head(dtm.wfm)
#           doc8024 doc8032 doc8035
#가동             1       0       0
#가슴             0       1       0
#가운데           0       0       1
#가져달라고       0       1       0
...
cosine(dtm.wfm)
#           doc8024    doc8032   doc8035
#doc8024 1.00000000 0.06350916 0.4041569
#doc8032 0.06350916 1.00000000 0.1135831
#doc8035 0.40415687 0.11358312 1.0000000


# 코사인 거리(Cosine distance)를 이용한 문서 간 유사도 비교하기
as.matrix(dist(dtm.mtx, method = "cosine"))
#          doc8024   doc8032   doc8035
#doc8024 0.0000000 0.9364908 0.5958431
#doc8032 0.9364908 0.0000000 0.8864169
#doc8035 0.5958431 0.8864169 0.0000000
