...
packages <- c("tm", "tidyverse", "stringr", "wordcloud", "DT")
load_pkgs(packages)
...
dtm <- DocumentTermMatrix(atc.corpus)
dtm
#<<DocumentTermMatrix (documents: 3, terms: 86)>>
#Non-/sparse entries: 93/165
#Sparsity           : 64%
